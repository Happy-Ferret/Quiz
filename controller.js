...
rnd=Math.ceil(rnd);
 ...
 var time2 = questionBank[questionNumber][6].length + questionBank[questionNumber][5].length * 50;
...
$(stage).append('<div class="questionText">'+questionBank[questionNumber][0]+'</div><div id="1" class="option">'+q1+'</div><div id="2" class="option">'+q2+'</div><div id="3" class="option">'+q3+'</div><div id="4" class="option">'+q4+'</div>');
 ...
 $('.option').click(function(){
  ...
  if(this.id!=rnd){
   $(stage).append('<div class="feedback2">'+questionBank[questionNumber][6]+ "<p></p>" + questionBank[questionNumber][5]+'</div>');
  setTimeout(function(){changeQuestion()}, time2 );
	...
	// Display final score alongside total number of questions answered.
